...
public class Aemet {
	...
	//array donde guardaremos los datos de cada dia del XML
	private ArrayList<Dia> dias;
	
	public Aemet() 
	{
		//aqui ponemos la web a usar (donde esta el XML)
		...
		//entramos en la primera etiqueta del xml q es prediccion
		Element elementPredicion = (Element) doc.getElementsByTagName("prediccion").item(0);
		//dentro de esta tomamos el tag dia
		...
		for (int i=0; i < nodosDias.getLength(); i++) 
		{
			...
			dia = new Dia(); //objeto clase dia(del model)
